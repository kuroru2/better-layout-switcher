...
class FnTapDetector {
    ...
    func start() {
        ...
        guard let eventTap = CGEvent.tapCreate(
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = """
                    FnLightSwitch needs Accessibility permission to detect Fn key presses.

                    Go to System Settings → Privacy & Security → Accessibility \
                    and add FnLightSwitch to the list.
                    """
        ...
        print("✅ FnLightSwitch running (tap threshold: \(FnTapDetector.tapThresholdMs)ms)")
    }
